...
public class JsonRpcBasicServer {
	...
	/**
	 * Wraps executorService with DelegatingSecurityContextExecutorService
	 */
	public void wrapBatchExecutorService() {
		if (securityServletRequestResolver != null) {
			this.batchExecutorService = securityServletRequestResolver.transformExecutorService(batchExecutorService);
		}
	}
